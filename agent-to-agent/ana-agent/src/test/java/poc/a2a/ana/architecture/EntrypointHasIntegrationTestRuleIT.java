package poc.a2a.ana.architecture;
...
// Mesma regra do analizza-auction. Sem Kafka e sem @McpTool neste agente -> checa apenas @RestController e @Scheduled.
@Tag("integration")
class EntrypointHasIntegrationTestRuleIT {

    private final JavaClasses importedClasses = new ClassFileImporter()
            .importPackages("poc.a2a.ana");
